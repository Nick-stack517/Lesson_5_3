...
Метод iadd в Python позволяет реализовать сложение с присваиванием (оператор +=).
Он изменяет сам объект, не создавая новые объекты.

Метод radd используется для сложения, когда экземпляр класса находится справа от оператора +,
а слева от + не является экземпляром класса.
"""
